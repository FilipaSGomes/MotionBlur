...
int main(int argc, const char * argv[]) {
    ...
    /* Cornell Box */
    //CornellBox(scene);
    BallBoxRevealScene(scene);
    //DeformCornellBox(scene);
    /* Deforming Square */
    //DeformQuadScene(scene);
    //BallsScene(scene);
    // Câmara para a DeformQuadScene
    //const Point Eye ={0,2,-8}, At={0,2,10};
    //const float deFocusRad = 0*3.14f/180.f;
    //const float FocusDist = 18.;
